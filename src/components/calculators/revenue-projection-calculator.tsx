...
export function RevenueProjectionCalculator() {
  ...
  useEffect(() => {
    setInitialUsers(Number(searchParams.get('initialUsers')) || 100);
    setGrowthRate(Number(searchParams.get('growthRate')) || 20);
    setArpu(Number(searchParams.get('arpu')) || 25);
    setChurnRate(Number(searchParams.get('churnRate')) || 5);
  }, [searchParams]);
