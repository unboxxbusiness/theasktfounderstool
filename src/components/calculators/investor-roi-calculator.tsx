...
export function InvestorRoiCalculator() {
  ...
  useEffect(() => {
    setInvestmentAmount(Number(searchParams.get('investmentAmount')) || 250000);
    setEquityPercentage(Number(searchParams.get('equityPercentage')) || 10);
    setExitValuation(Number(searchParams.get('exitValuation')) || 100000000);
  }, [searchParams]);
