...
export function PricingStrategyCalculator() {
  ...
  useEffect(() => {
    setCostPerUnit(Number(searchParams.get('costPerUnit')) || 15);
    setDesiredMargin(Number(searchParams.get('desiredMargin')) || 70);
    setCompetitorPrice(Number(searchParams.get('competitorPrice')) || 60);
  }, [searchParams]);
