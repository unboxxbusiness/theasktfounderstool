...
export function ValuationCalculator() {
  ...
  useEffect(() => {
    setAnnualRevenue(Number(searchParams.get('annualRevenue')) || 100000);
    setGrowthRate(Number(searchParams.get('growthRate')) || 50);
    setIndustry(searchParams.get('industry') || 'SaaS');
    setStage(searchParams.get('stage') || 'Seed');
  }, [searchParams]);
