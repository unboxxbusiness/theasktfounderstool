...
export function FundraisingGoalCalculator() {
  ...
  useEffect(() => {
    setMonthlyBurn(Number(searchParams.get('monthlyBurn')) || 50000);
    setTargetRunway(Number(searchParams.get('targetRunway')) || 18);
    setBuffer(Number(searchParams.get('buffer')) || 25);
  }, [searchParams]);
