...
export function BreakEvenCalculator() {
  ...
  useEffect(() => {
    setFixedCosts(Number(searchParams.get('fixedCosts')) || 20000);
    setPricePerUnit(Number(searchParams.get('pricePerUnit')) || 50);
    setVariableCostPerUnit(Number(searchParams.get('variableCostPerUnit')) || 15);
  }, [searchParams]);
